...
const demoMessages = [
  ...
  },
  {
    role: "bot",
    content:
      "Yes, we currently have the AirPods Pro (2nd generation) in stock! They're priced at $249 and feature active noise cancellation, transparency mode, and spatial audio. Would you like to know more about their features or are you interested in purchasing them?",
    delay: 1,
  },
  {
    role: "user",
  ...
  },
  {
    role: "bot",
    content:
      "The AirPods Pro come in white only. The case has a glossy finish and supports both MagSafe and wireless charging. Would you like to add a pair to your cart?",
    delay: 2,
  },
]
            ...
            <div className="h-96 overflow-y-auto p-6">
              <div className="flex flex-col space-y-4">
                {chatMessages.map((msg, index) => (
                  ...
                  >
                    <div
                      className={`max-w-[80%] ${msg.role === "user" ? "bg-primary text-primary-foreground" : "bg-muted"} rounded-2xl px-4 py-3`}
                    >
